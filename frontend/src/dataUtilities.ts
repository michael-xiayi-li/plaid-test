...
export const balanceHistoryCategories: Array<Categories> = [
  {
    title: "Account",
    field: "account",
  },
...
interface BalanceHistoryResponseData {
  accounts: DataItem[];
}

export const transformBalanceHistoryData = (data: BalanceHistoryResponseData) => {
