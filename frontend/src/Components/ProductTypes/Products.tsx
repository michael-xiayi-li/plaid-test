...
const Products = () => {
  ...
  return (
    <ProductTypesContainer productType="Products">
      ...
      />
      <Endpoint
        endpoint="balance_history"
        name="Balance History"
        categories={balanceHistoryCategories}
        schema="route n/a"
        description="Retrieve Account history percentage"
        transformData={transformBalanceHistoryData}
      />
